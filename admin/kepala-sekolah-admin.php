    ...
    <header>
        <div class="head-container">
            <div class="head-title">
                ...
                <span class="text">Kepala Sekolah</span>
            </div>
            ...
            <div class="page-content">
                ...
                <div class="content-details">
                    <div class="head-content">
                        <a href="tambah-admin.php?level=3">Tambah</a>
                    </div>
                        ...
                        <table class="content-table">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $rows = $readObj->getHeadmasterData();
                                ?>
                                ...
                                <?php foreach($rows as $row) : ?>
                                        <tr>
                                            ...
                                            <td><?= $row['no_hp']; ?></td>
                                            <td>
                                                <a href="update-kepsek-admin.php?id=<?= $row['user_id']; ?>&level=3" class="edit"><i class='bx bx-edit-alt'></i></a>
                                                <a href="../includes/delete-inc.php?id=<?= $row['user_id']; ?>&level=3" class="delete"><i class='bx bx-trash' ></i></a>
                                            </td>
                                        </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
